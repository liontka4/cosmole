...
while True:
	...
	print("")
	time.sleep(1)
	print(" - Капитан, вам поручается управление")
	print("космическим кораблём Крот для")
	print("исследования пространственных")
	print("складок - своего рода астрономического")
	print("фронтира. Для перехода сквозь складку")
	print("Крот оснащён сверхсветовым ускорителем.")
	print("Используйте его. Но помните, если рывок")
	print("будет направлен мимо складки, то")
	print("произойдёт авария.")
	print("")
	print("")
	time.sleep(1)
	print("КОМАНДЫ")
